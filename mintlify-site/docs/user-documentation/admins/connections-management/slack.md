...
Channel labels use `channelId:...` and `channelName:...` and can filter the [knowledge search tool](/docs/user-documentation/agents/knowledge/search-data-sources).
...
For authorization, migration, or missing-channel problems, see [Slack troubleshooting](/docs/user-documentation/admins/admin-troubleshooting/slack-troubleshooting). For live Slack actions, see [Slack tools](/docs/user-documentation/agents/tools/slack-tools).
