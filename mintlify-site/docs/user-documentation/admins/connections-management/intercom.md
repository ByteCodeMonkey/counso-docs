...
Conversation attributes become labels in the form `attribute:name:value`; tags use `tag:name`. Agents can use these in [knowledge search filters](/docs/user-documentation/agents/knowledge/search-data-sources).
