...
SharePoint list custom columns are included as labels with synchronized files. They can support keyword filtering and [knowledge search](/docs/user-documentation/agents/knowledge/search-data-sources).
