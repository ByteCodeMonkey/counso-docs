...
Ask a [table-query](/docs/user-documentation/agents/knowledge/table-queries) question with a known expected result. **Tools inspection** shows the SQL and result used for the answer, which also helps identify incorrect joins or filters.
