---
title: "Plan access to workspace data"
---
...
For role and group controls, see [Workspace roles, groups, and permissions](/docs/user-documentation/admins/admin-governance/workspace-governance-roles-groups-and-permissions).
