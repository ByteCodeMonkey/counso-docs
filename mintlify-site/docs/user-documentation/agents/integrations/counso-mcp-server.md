---
title: "Connect an MCP client to Counso"
---
...
To give a Counso Agent access to a third-party service instead, see [Add a remote MCP server](/docs/user-documentation/admins/tools-management/adding-an-mcp-server).
