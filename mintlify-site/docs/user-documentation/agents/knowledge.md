...
| **Find in data sources** | Browsing connected data by folder, path, or document title | Lists folders, opens a document by path, locates a document by title, and reports its place in the hierarchy. It complements semantic search when source structure matters. |
...
For exact procedures, see [Search data sources](/docs/user-documentation/agents/knowledge/search-data-sources), [Include Data](/docs/user-documentation/agents/knowledge/include-data), [Table queries](/docs/user-documentation/agents/knowledge/table-queries), and [Extract data](/docs/user-documentation/agents/knowledge/extract-data). Find in data sources is available with supported Search configurations and does not require a separate source selection.
