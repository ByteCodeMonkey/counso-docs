...
This structure supports retrieval-augmented generation (RAG): an Agent uses selected passages from a larger collection to answer a request. For document insertion, replacement, and deletion behavior, see [Data sources](/docs/developer-platform/core-concepts/datasources).
