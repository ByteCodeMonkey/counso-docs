...
Download the complete [OpenAPI / Postman](/docs/developer-platform/counso-api-documentation/openapi-and-postman) files.
          ...
          },
          {
            ...
            "properties": {
              ...
              "pinnedFramePath": {
                "type": "string",
                "nullable": true,
                "description": "Scoped path to the MiniApp file pinned as the Pod banner (e.g. project/banner.html)."
              },
              "frameTabs": {
                "type": "array",
                ...
                "items": {
                  ...
                  "properties": {
                    "path": {
                      "type": "string",
                      "description": "Canonical scoped path to the MiniApp file in the Pod filesystem."
                    },
                    "title": {
                      "type": "string",
