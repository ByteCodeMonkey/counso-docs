---
title: "API 规范与 Postman"
---
Counso API 定义文件用于查看请求与响应结构；将请求集合导入 Postman 后，可以逐个选择接口并发送请求。

- [Postman 请求集合](/zh-Hans/docs/developer-platform/counso-api-documentation/postman.collection.json)
- [Postman 环境文件](/zh-Hans/docs/developer-platform/counso-api-documentation/postman.environment.json)
- [OpenAPI 3.0 规范](/zh-Hans/docs/developer-platform/counso-api-documentation/openapi.json)
- [swagger.json 格式文件](/zh-Hans/docs/developer-platform/counso-api-documentation/swagger.json)
