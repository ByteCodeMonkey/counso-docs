...
SDK 使用 Result 风格返回结果。读取 `value` 前先检查 `isErr()`，并在继续处理前妥善处理 API 错误。[Conversations API 参考](/zh-Hans/docs/developer-platform/counso-api-documentation/openapi-and-postman)列出了请求字段和可用操作。
