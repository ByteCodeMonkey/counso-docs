...
清楚具体的问题有助于搜索找到正确材料。保持智能体的数据来源范围聚焦，要求引用来源；完整总数应通过结构化查询核算，而不是根据检索片段估算。另见[搜索数据源](/zh-Hans/docs/user-documentation/agents/knowledge/search-data-sources)和[Knowledge 方法](/zh-Hans/docs/user-documentation/agents/knowledge)。
