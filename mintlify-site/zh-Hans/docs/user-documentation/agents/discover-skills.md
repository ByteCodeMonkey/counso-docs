...
通用智能体需要处理多种请求，或工作区持续为不同团队增加可复用 Skill 时，可以启用 Discover Skills。它能保持智能体初始配置聚焦，同时让新发布的可发现流程无需逐个修改智能体就可使用。可见性设置见[Skill 可用性](/zh-Hans/docs/user-documentation/agents/skill-availability)。
