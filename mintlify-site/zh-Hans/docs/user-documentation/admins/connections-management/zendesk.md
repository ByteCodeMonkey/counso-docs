...
工单标签，以及 `priority`、`ticketType`、`channel`、`status`、`groupId`、`organizationId`、`dueDate`、`satisfactionRating`、`hasIncidents` 等标签，可用于缩小[知识搜索](/zh-Hans/docs/user-documentation/agents/knowledge/search-data-sources)范围。
