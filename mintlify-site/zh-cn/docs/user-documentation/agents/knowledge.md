...
具体操作见[搜索数据源](/zh-cn/docs/user-documentation/agents/knowledge/search-data-sources)、[Include Data](/zh-cn/docs/user-documentation/agents/knowledge/include-data)、[表格查询](/zh-cn/docs/user-documentation/agents/knowledge/table-queries)和[提取数据](/zh-cn/docs/user-documentation/agents/knowledge/extract-data)。
