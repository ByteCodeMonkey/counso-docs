...
调整可用性前，检查 Skill 附加的 Knowledge、Tools 和必需 Space。让 Skill 可被发现不会自动授予用户或智能体访问这些资源的权限。自动发现方式见[发现 Skills](/zh-cn/docs/user-documentation/agents/discover-skills)。
