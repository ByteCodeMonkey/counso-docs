...
具体操作见[搜索数据源](search-data-sources.md)、[Include Data](include-data.md)、[表格查询](table-queries.md)和[提取数据](extract-data.md)。受支持的 Search 配置会同时提供 Find in data sources，无需另选一套数据源。
